...
public final class EndecryptUtils {
    ...
    /** 
     * 注册时对密码进行md5加密,并返回密文和salt，包含在User对象中 
     * @param username 用户名 
     * @param password 密码 
    ...
    public static User md5Password(String username,String password,boolean base64){ 
        ...
        String password_cipherText= null;
        if(base64){
        	password_cipherText = new Md5Hash(password,username+salt,2).toBase64(); 
        }else{
    ...
    public static void main(String[] args) { 
    	...
    	String password_cipherText= new Md5Hash("123456","lsl"+salt,2).toHex(); 
